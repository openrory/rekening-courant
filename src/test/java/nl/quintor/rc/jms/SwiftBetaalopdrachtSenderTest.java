...
public class SwiftBetaalopdrachtSenderTest {

    private SwiftBetaalopdrachtSender sender = new SwiftBetaalopdrachtSender();
    ...
    public void setup() throws JMSException {
        ...
        sender.setSwiftBetaalopdrachtTemplate(template);
    }

    @Test
    public void testSendBetaalopdracht() throws JMSException {
        ...
        sender.sendBetaalopdracht(betaalopdracht);

        MessageConsumer consumer = session.createConsumer(destination);
        TextMessage message = (TextMessage) consumer.receive(300);

        assertThat(message.getJMSType(), is("nl.quintor.rc.jms.dto.BetaalopdrachtDto"));
        assertThat(message.getText(), is("{\"betaalopdrachtId\":\"42\",\"uitvoerdatum\":\"22-10-2014\",\"debiteurNaam\":\"dnaam\",\"debiteurIBAN\":\"diban\",\"debiteurBIC\":\"dbic\",\"crediteurNaam\":\"cnaam\",\"crediteurIBAN\":\"ciban\",\"crediteurBIC\":\"cbic\",\"bedrag\":123.45,\"omschrijving\":\"description\"}"));
    }
